...
// Native implements [Value]. Returns a []any with all live elements
// recursively materialised.
func (lv ListView) Native() any {
	return materializeObj(lv.s, lv.obj, types.ActionMakeList)
}
...
// TODO: missing methods to insert at arbitrary index
